...
const HERO = {
  image: "assets/sbp-building-hero.jpg",
      ...
      <header id="intro-header" class="sticky top-0 z-30 bg-white" style="border-bottom:1px solid ${G.border};">
        <div class="max-w-7xl mx-auto px-6 lg:px-10 h-[66px] flex items-center justify-between gap-8">
          <div class="flex items-center gap-3 flex-shrink-0">
            <img data-fallback src="assets/state_bank_of_pakistan_logo-2.png" alt="SBP" class="w-11 h-11 object-contain" />
            <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
            <div class="md:col-span-1">
              <div class="flex items-center gap-3 mb-4">
                <img data-fallback src="assets/state_bank_of_pakistan_logo-2.png" alt="SBP" class="w-10 h-10 object-contain" />
                <div>
...
function wireEvents(container) {
  ...
  qs("#hero-cta", container).addEventListener("click", () => navigate("/sme/login"));
