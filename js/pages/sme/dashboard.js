...
export function render(container) {
  ...
  const CARDS = [
    { label: "Draft", value: counts.draft, iconName: "file-text", color: C.textMuted, path: "" },
    { label: "Submitted", value: counts.submitted, iconName: "arrow-up-right", color: C.blue, path: "" },
    { label: "Under Review", value: counts.under_review, iconName: "clock", color: "#D97706", path: "/sme/tracking" },
    { label: "Approved", value: counts.approved, iconName: "check-circle-2", color: C.green, path: "/sme/offer" },
    { label: "Rejected", value: counts.rejected, iconName: "x-circle", color: "#DC2626", path: "" },
    { label: "Disbursed", value: counts.disbursed, iconName: "banknote", color: C.greenDark, path: "" },
  ];
  ...
  const tableInner = `
    <div class="rounded-2xl overflow-hidden" style="background:${C.surface};">
      <div class="flex items-center justify-between px-5 py-4 border-b" style="border-color:${C.border};">
        ...
        <button class="text-xs flex items-center gap-1 font-bold" style="color:${C.green};">
