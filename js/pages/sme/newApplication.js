...
function requiredDocLabels(businessStatus) {
        ...
        <div class="bg-white rounded-2xl max-w-lg w-full shadow-2xl max-h-[90vh] overflow-y-auto">
          <div class="p-6">
            ...
            <div class="flex gap-3">
              ...
              <button data-agree-submit ${agreedToUndertaking ? "" : "disabled"}
                ...
                Agree &amp; Submit ${icon("check-circle-2", { size: 16, color: "#fff" })}
              </button>
            </div>
          </div>
        </div>
